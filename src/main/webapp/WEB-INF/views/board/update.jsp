...
<form action="/board/update?b_id=${board.b_id}" method="post" onclick="return check()">
  ...
  <div style="width: 100%; display: flex; justify-content: center; margin-top: 50px">
    <div style="width: 30%; margin: 50px auto 0 auto; ">
      ...
      <input type="text" name="b_title" placeholder="제목을 적어주세요" style="width: 100%; border: 3px solid lightgrey" value="${board.b_title}">
      <div style="color: black; font-size: 25px; text-align: left">내용</div>
      <textarea name ="b_content" rows="10" cols="50" style="width: 100%; border: 3px solid lightgrey;">${board.b_content}</textarea>
