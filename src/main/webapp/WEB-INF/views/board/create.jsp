...
<form action="/board/create" method="post" onsubmit="return check()">
    ...
    <div style="width: 100%; display: flex; justify-content: center; margin-top: 50px">
     <div style="width: 30%; margin: 50px auto 0 auto; ">
          <div style="color: black; font-size: 25px; text-align: left">Title</div>
            <input type="text" id="b_title" name="b_title" placeholder="제목을 적어주세요" style="width: 100%; border: 3px solid lightblue">
          <div style="color: black; font-size: 25px; text-align: left">내용</div>
            <textarea name ="b_content" id = "b_content" rows="10" cols="50" style="width: 100%; border: 3px solid lightblue"></textarea>
